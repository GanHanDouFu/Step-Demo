...
4. 古人知己必须是真实历史人物，要说明具体的人生阶段和相识故事。friend_stage 格式严格为"阶段·朝代年号"（如"壮年游历·开元年间"），不可只写阶段不写时期。阶段要多样化，每次从不同角度切入。阶段可选：年少求学、初入仕途、壮年游历、贬谪流离、沙场征战、田园归隐、酒肆偶逢、书院论道、寺庙参禅、江边垂钓、月下独酌、雪夜访友、科举落第、边塞戍守、市井闲逛、山水偶遇、晚年著书、病中相慰。时期必须是真实历史年号（如开元、贞观、建安、靖康、万历等），不可编造。
5. 赠言要仿写古人风格，有韵味
...
请严格按以下JSON格式返回，不要有其他文字：
{
  ...
  "friend": "匹配的真实历史人物姓名",
  "friend_era": "历史人物的时代和身份，简短一句话（如'唐代诗人''东晋画家'）",
